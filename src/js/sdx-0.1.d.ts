...
declare module 'Sdx' {
    ...
    export function createGame(name: string, height: number, width: number, base: string):GObject.Object
    export function createSprite(path: string):GObject.Object
    export function createJz():GObject.Object
    ...
    export class JzGame extends GObject.Object {
        constructor(config?: any)
        get_mouseDown():boolean
        set_mouseDown(value: boolean):void
        get_mousex():number
        set_mousex(value: number):void
        get_mousey():number
        set_mousey(value: number):void
        get_running():boolean
        set_running(value: boolean):void
        get_name():string
        set_name(value: string):void
        ...
        set_fps(value: number):void
        get_showFps():boolean
        set_showFps(value: boolean):void
        get_deltaTime():number
        set_deltaTime(value: number):void
        get_width():number
        set_width(value: number):void
        get_height():number
        set_height(value: number):void
