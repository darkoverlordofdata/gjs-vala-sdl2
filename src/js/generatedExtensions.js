...
(function(){
  ...
  var BoundsComponent = example.BoundsComponent;
  var BulletComponent = example.BulletComponent;
  var ColorAnimationComponent = example.ColorAnimationComponent;
  ...
  var ScaleAnimationComponent = example.ScaleAnimationComponent;
  var SoundEffectComponent = example.SoundEffectComponent;
  var SpriteComponent = example.SpriteComponent;
  var VelocityComponent = example.VelocityComponent;
  var ScoreComponent = example.ScoreComponent;
  var DestroyComponent = example.DestroyComponent;
  var MouseComponent = example.MouseComponent;
  var ScaleComponent = example.ScaleComponent;
  var ResourceComponent = example.ResourceComponent;
  var LayerComponent = example.LayerComponent;
  ...
  /** @type {{example.ColorAnimationComponent} */
  ...
  /** @type {example.ParallaxStarComponent} */
  ...
  /** @type {{example.PositionComponent} */
  ...
  /** @type {{example.ScaleAnimationComponent} */
  ...
  /** @type {{example.SoundEffectComponent} */
  ...
  /** @type {{example.VelocityComponent} */
  ...
  /** @type {{example.ResourceComponent} */
